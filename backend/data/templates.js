// Collection of LaTeX Resume Templates for Manpreet Singh
// Supporting all templates provided by user with dynamic data binding.
...
const templates = {
  // Template 1: Official Academic LaTeX (Latin Modern Roman)
  'classic': {
    id: 'classic',
    name: 'Classic Academic (Official)',
    description: 'Computer Modern / Latin Modern serif styling with small-caps section titles, tabularx education, and clean dividers.',
    primaryColor: '#000000',
...
\\end{document}`;
  ...
  // Template 2: Modern Navy Accent
  'modern-navy': {
    id: 'modern-navy',
    name: 'Modern Navy Accent',
    description: 'Executive layout with Navy Blue (#1e4678) section headings, compact margins, and clean horizontal dividers.',
    primaryColor: '#1e4678',
    layout: 'single-column',
    generateLatex: (d) => {
...
\\end{document}`;
  ...
  // Template 3: Modern Two-Column Layout (Paracol)
  'two-column': {
    id: 'two-column',
    name: 'Modern Two-Column',
    description: 'Modern two-column layout with sidebar for contact, technical skills, and certifications, leaving space for experience & projects.',
    primaryColor: '#1e508c',
    layout: 'two-column',
    generateLatex: (d) => {
...
\\end{document}`;
  ...
  // Template 4: Software Developer (Tabular Skills & Dedicated Internship)
  'software-dev': {
    id: 'software-dev',
    name: 'Software Engineer (Tabular Skills)',
